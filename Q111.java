import static WeekdayCalculator.WeekdayName;
import static WeekdayCalculator.WeekdayName;
import static WeekdayCalculator.WeekdayName;
import static WeekdayCalculator.WeekdayName;
import static WeekdayCalculator.WeekdayName;
...
public class Q111
{
	...
	public static String weekday( int mm, int dd, int yyyy )
	{
		...
		yy=yyyy-1900;
		    ...
		    result=Q102.month_offset(mm);
		    total=(yy/4) + yy + dd + result;
		    
		    lp=Q103.is_leap(yyyy);
		    mnth=Q101.month_name(mm);
		  ...
		  rem=total%7;
		date = WeekdayName.weekday_name(rem) + ", "+ Q101.month_name(mm) + " "+ dd +", " + yyyy;
